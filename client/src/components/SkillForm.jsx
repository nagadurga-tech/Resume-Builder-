  ...
  return (
    <div className="space-y-4">
        ...
        <div className="flex flex-col sm:flex-row gap-2">
            <input type="text" placeholder="Enter a Skill (e.g.,JavaScript,Communication)" className="w-full sm:flex-1 px-3 py-2 text-sm rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none"
            onChange={(e)=>setNewSkill(e.target.value)} value={newSkill} onKeyDown={handleKeyPress}/>
            <button onClick={addSkill} className=" flex item-center justify-center gap-2 px-4 py-2 text-sm bg-blue-600 text-white rounded-lg
