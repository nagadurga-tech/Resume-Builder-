        ...
        <label>
          {data.image ? (
            <img
              ...
              alt="user"
              className={`w-16 h-16 rounded-full object-cover mt-5 
                ring ring-slate-300 hover:opacity-80 transition 
                ${removeBackground ? "bg-white" : "bg-slate-200"}`}
            />
          ) : (
        ...
        {data.image && (
          <div className="flex flex-col gap-1 pl-2 text-sm">
            ...
            <label className="relative inline-flex items-center cursor-pointer">
              ...
              />
              <div className="w-10 h-5 bg-slate-300 rounded-full peer-checked:bg-green-600 transition-colors relative">
                <span
